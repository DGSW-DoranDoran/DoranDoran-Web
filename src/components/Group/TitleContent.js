    ...
    <>
      ...
      <div className="group-form-bottom">
        <div className= "group-form-div">
          <h3 className="group-form-bottom-txt" style={{marginRight:'3%'}}>멤버수: {curMember}명/{maxMember}명 </h3>
          <button type="button" className="group-btn" onClick={() => setFlag(1)}><FontAwesomeIcon icon={faAngleDoubleDown} /></button>
        </div>
        {
          flag === 1
          && memberDiv
